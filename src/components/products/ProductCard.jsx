  ...
  return (
    <div className="group overflow-hidden hover:shadow-lg transition-all duration-300 border border-border bg-card rounded-lg flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        {/* Title */}
        <h3 className="font-semibold text-foreground mb-2 line-clamp-2 text-sm">product title</h3>

        {/* Rating */}
        <div className="flex items-center gap-2 mb-3">
          <div className="flex text-yellow-400">{"★".repeat(Math.round( 4))}</div>
